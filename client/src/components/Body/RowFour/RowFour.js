...
class RowFour extends Component {
  ...
  render() {
    return (
      <div class="row">
        <DashBoardChart
          ratios={this.props.rowFourTotals.data}
          titles={this.props.benchmarkTitles}
          placeHolder={"Current Portfolio"}
        />

        <DashBoardChart
          name={this.props.benchmarkName}
          ratios={this.props.benchmarkRatios}
          titles={this.props.benchmarkTitles}
          placeHolder={"Current Benchmark: "}
        />
      </div>
    );
  }
...
export default connect(mapStateToProps, null)(RowFour);
